namespace GroceriesStore.Services.Catalog.API.Infrastructure;
...
public class CatalogContextSeed
{
    public async Task SeedAsync(CatalogContext context, IWebHostEnvironment env, IOptions<CatalogSettings> settings, ILogger<CatalogContextSeed> logger)
    {
        ...
        await policy.ExecuteAsync(async () =>
        {
            ...
            {
                await context.CatalogBrands.AddRangeAsync(GetCatalogBrandsFromFile(contentRootPath, logger));
            ...
            {
                await context.CatalogTypes.AddRangeAsync(GetCatalogTypesFromFile(contentRootPath, logger));
            ...
            {
                await context.CatalogItems.AddRangeAsync(GetCatalogItemsFromFile(contentRootPath, context, logger));
