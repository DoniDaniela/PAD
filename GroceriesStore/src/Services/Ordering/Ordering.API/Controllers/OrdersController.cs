using CardType = GroceriesStore.Services.Ordering.API.Application.Queries.CardType;
using Order = GroceriesStore.Services.Ordering.API.Application.Queries.Order;

namespace GroceriesStore.Services.Ordering.API.Controllers;
