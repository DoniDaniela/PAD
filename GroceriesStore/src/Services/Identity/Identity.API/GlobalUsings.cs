...
global using GroceriesStore.Services.Identity.API;
global using GroceriesStore.Services.Identity.API.Configuration;
global using GroceriesStore.Services.Identity.API.Data;
global using GroceriesStore.Services.Identity.API.Models;
global using GroceriesStore.Services.Identity.API.Services;
